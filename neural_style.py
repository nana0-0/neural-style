...
def main():
    ...
    for iteration, image, loss_vals in stylize(
        ...
        if (loss_vals is not None) and (
            options.progress_plot or options.progress_write
        ):
